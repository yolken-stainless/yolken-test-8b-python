...
from ._exceptions import APIStatusError, YolkenTest8bError
...
class YolkenTest8b(SyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous YolkenTest8b client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("YOLKEN_TEST_8B_BASE_URL")
        if base_url is None:
    ...
    @cached_property
    def with_raw_response(self) -> YolkenTest8bWithRawResponse:
        return YolkenTest8bWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> YolkenTest8bWithStreamedResponse:
        return YolkenTest8bWithStreamedResponse(self)
...
class AsyncYolkenTest8b(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncYolkenTest8b client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncYolkenTest8bWithRawResponse:
        return AsyncYolkenTest8bWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncYolkenTest8bWithStreamedResponse:
        return AsyncYolkenTest8bWithStreamedResponse(self)
...
class YolkenTest8bWithRawResponse:
    _client: YolkenTest8b

    def __init__(self, client: YolkenTest8b) -> None:
        self._client = client
...
class AsyncYolkenTest8bWithRawResponse:
    _client: AsyncYolkenTest8b

    def __init__(self, client: AsyncYolkenTest8b) -> None:
        self._client = client
...
class YolkenTest8bWithStreamedResponse:
    _client: YolkenTest8b
...
class AsyncYolkenTest8bWithStreamedResponse:
    _client: AsyncYolkenTest8b
