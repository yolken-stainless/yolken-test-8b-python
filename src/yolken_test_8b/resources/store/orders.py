...
class OrdersResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> OrdersResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/yolken-stainless/yolken-test-8b-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> OrdersResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/yolken-stainless/yolken-test-8b-python#with_streaming_response
        """
